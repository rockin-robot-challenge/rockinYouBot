...
#include "rockin_teleop/RockinTeleopJoypadConfig.h"
...
class TeleOpJoypad
{
 ...
 private:
    ...
    void cbDynamicReconfigure(rockin_teleop::RockinTeleopJoypadConfig &config, uint32_t level);
    ...
    dynamic_reconfigure::Server<rockin_teleop::RockinTeleopJoypadConfig> dyn_recfg_server;
    dynamic_reconfigure::Server<rockin_teleop::RockinTeleopJoypadConfig>::CallbackType dyn_recfg_cb;

    rockin_teleop::RockinTeleopJoypadConfig teleop_config_;
