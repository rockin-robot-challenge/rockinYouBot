...
#include <rockin_navigation_msgs/OrientToBaseAction.h>

int main (int argc, char **argv)
{
  ros::init(argc, argv, "base_orientation_Test");

  actionlib::SimpleActionClient<rockin_navigation_msgs::OrientToBaseAction> ac("/rockin_navigation/base_placement/adjust_to_workspace", true);
  ...
  rockin_navigation_msgs::OrientToBaseActionGoal goal;
